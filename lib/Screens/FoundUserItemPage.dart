...
class FoundUserItemPage extends StatefulWidget {
  const FoundUserItemPage({Key? key}) : super(key: key);

  @override
  State<FoundUserItemPage> createState() => _FoundUserItemPagState();
}

class _FoundUserItemPagState extends State<FoundUserItemPage> {
